...
<html lang="hr">
    <head>
        ...
        <script src="JavaScript/pregledVijest.js"></script>
    </head>
    ...
    <body>
        ...
        <section>
            <h3>Pregled vlastitih vijesti</h3>
            <div id="formaVijesti">
                <form>
            ...
            <div>
                ...
                <a href="dodavanjeNoveVijesti.php"><button id="kreiranjeVijestiButton">Kreiranje vijesti</button></a>
