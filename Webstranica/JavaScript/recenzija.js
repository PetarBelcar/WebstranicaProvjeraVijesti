...
function ucitavanjeNovihElementa(brojElementaPoStranici, brojStranice)
{
    ...
    $.ajax(
        {
            method      :"GET",
            url         :"PHPFunkcijskiPaketi/dohvacanjePogreskaModerator.php",
            data        :podatci,
            datatype    :"json",
            success     : function(tablica){
                ...
                $.each(tablica ,function(key, vijest){
                    sadrzajGalerije += "<tr> <td>" + vijest['nazivGreške'] + "</td> <td>" + vijest['pocetakGreske'] + "</td> <td>" + vijest['krajGreske'] + "</td>  <td>" + vijest['opis'] + "</td> </tr>";
